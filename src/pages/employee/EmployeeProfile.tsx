...
import { FiMail, FiCalendar, FiBriefcase, FiUsers, FiCheckCircle } from 'react-icons/fi';
...
export const EmployeeProfile = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="My Profile" 
        description="View your personal information and task history" 
      />
          ...
          <CardContent>
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                As an employee, you can submit tasks, view your task history, and provide feedback.
              </p>
              <div className="pt-2">
                <Badge variant="outline">Employee Access</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 border rounded-lg">
              <FiCheckCircle className="h-8 w-8 mx-auto mb-2 text-green-600" />
              <p className="text-2xl font-bold">0</p>
              <p className="text-sm text-muted-foreground">Tasks Completed</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              <FiCalendar className="h-8 w-8 mx-auto mb-2 text-blue-600" />
              <p className="text-2xl font-bold">0</p>
              <p className="text-sm text-muted-foreground">Pending Tasks</p>
            </div>
            <div className="text-center p-4 border rounded-lg">
              <FiBriefcase className="h-8 w-8 mx-auto mb-2 text-purple-600" />
              <p className="text-2xl font-bold">0</p>
